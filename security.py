...
Wireshark ya no muestre el JSON en texto plano y, además, detecta mensajes
alterados gracias a la verificación de integridad del token.

IMPORTANTE: La clave se deja fija para facilitar la demo académica. En un
sistema real debería cargarse desde variables de entorno, un archivo seguro o
un mecanismo formal de gestión de claves.
"""
...
# También puede sobreescribirse con la variable de entorno SAFEVault_SECRET_KEY.
